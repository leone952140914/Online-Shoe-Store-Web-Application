...
<html>
    ...
    <body>
        ...
        <div id="profile" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
            ...
            <div id="container">
                    ...
                    <div class="modal-body">
                        <form method="post">
                            <center>
                                ...
                                <br />
                                <input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of Online Shoe Store 
                            </center>
                    </div>
                    <div class="modal-footer">
                        <center>
                ...
                <div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                        <h3 id="myModalLabel">Online Shoe Store </h3>
                    </div>
                    <div class="modal-body">
                        <ul>
        ...
        <div id="footer">
            <div class="foot">
                <label style="font-size:17px;"> Copyright &copy; Online Shoe Store UWU IIT </label>
